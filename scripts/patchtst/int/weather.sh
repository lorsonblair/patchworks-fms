...
do
    run_id=$model'_'$data_name'_'$seq_len'_'$pred_len'_'$prc'_'$qmode'_win-he_pe-rnd_gn-'$mgn'_ps02_pt02_ff02_ep'$eph'_rs'$seed
    ...
    python -u runexp.py \
      ...
      --learning_rate 1e-4 \
      --max_grad_norm $mgn \
      >logs/$model/$prc/$init_ckpt/$run_id'_bf16'.log
done
